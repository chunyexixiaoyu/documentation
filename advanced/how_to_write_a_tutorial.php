...
<blockquote>
<div><ul class="simple">
<li><p><a class="reference external" href="http://sphinx.pocoo.org/rest.html">http://sphinx.pocoo.org/rest.html</a> - official Sphinx documentation</p></li>
<li><p><a class="reference external" href="http://docutils.sourceforge.net/rst.html">http://docutils.sourceforge.net/rst.html</a> - official RST documentation</p></li>
<li><p><a class="reference external" href="http://www.siafoo.net/help/reST">http://www.siafoo.net/help/reST</a> - has a nice tutorial/set of examples</p></li>
</ul>
</div></blockquote>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">git</span> <span class="n">clone</span> <span class="n">https</span><span class="p">:</span><span class="o">//</span><span class="n">github</span><span class="o">.</span><span class="n">com</span><span class="o">/</span><span class="n">PointCloudLibrary</span><span class="o">/</span><span class="n">pcl</span>
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="o">/**</span> \<span class="n">brief</span> <span class="n">The</span> <span class="n">point</span> <span class="n">data</span><span class="o">.</span> <span class="o">*/</span>
<span class="n">std</span><span class="p">::</span><span class="n">vector</span><span class="o">&lt;</span><span class="n">PointT</span><span class="p">,</span> <span class="n">Eigen</span><span class="p">::</span><span class="n">aligned_allocator</span><span class="o">&lt;</span><span class="n">PointT</span><span class="o">&gt;</span> <span class="o">&gt;</span> <span class="n">points</span><span class="p">;</span>
</pre></div>
</div>
