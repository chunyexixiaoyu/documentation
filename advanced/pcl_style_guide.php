...
<ul class="simple">
<li><p><a class="reference internal" href="#naming" id="id4">1. Naming</a></p>
<ul>
<li><p><a class="reference internal" href="#files" id="id5">1.1. Files</a></p></li>
<li><p><a class="reference internal" href="#directories" id="id6">1.2. Directories</a></p></li>
<li><p><a class="reference internal" href="#includes" id="id7">1.3. Includes</a></p></li>
<li><p><a class="reference internal" href="#defines-macros" id="id8">1.4. Defines &amp; Macros</a></p></li>
<li><p><a class="reference internal" href="#namespaces" id="id9">1.5. Namespaces</a></p></li>
<li><p><a class="reference internal" href="#classes-structs" id="id10">1.6. Classes / Structs</a></p></li>
<li><p><a class="reference internal" href="#functions-methods" id="id11">1.7. Functions / Methods</a></p></li>
<li><p><a class="reference internal" href="#variables" id="id12">1.8. Variables</a></p>
<ul>
<li><p><a class="reference internal" href="#iterators" id="id13">1.8.1. Iterators</a></p></li>
<li><p><a class="reference internal" href="#constants" id="id14">1.8.2. Constants</a></p></li>
<li><p><a class="reference internal" href="#member-variables" id="id15">1.8.3. Member variables</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#return-statements" id="id16">1.9. Return statements</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#indentation-and-formatting" id="id17">2. Indentation and Formatting</a></p>
<ul>
<li><p><a class="reference internal" href="#id1" id="id18">2.1. Namespaces</a></p></li>
<li><p><a class="reference internal" href="#classes" id="id19">2.2. Classes</a></p></li>
<li><p><a class="reference internal" href="#id2" id="id20">2.3. Functions / Methods</a></p></li>
<li><p><a class="reference internal" href="#braces" id="id21">2.4. Braces</a></p></li>
<li><p><a class="reference internal" href="#spacing" id="id22">2.5. Spacing</a></p></li>
<li><p><a class="reference internal" href="#automatic-code-formatting" id="id23">2.6. Automatic code formatting</a></p>
<ul>
<li><p><a class="reference internal" href="#emacs" id="id24">2.6.1. Emacs</a></p></li>
<li><p><a class="reference internal" href="#uncrustify" id="id25">2.6.2. Uncrustify</a></p></li>
<li><p><a class="reference internal" href="#eclipse" id="id26">2.6.3 Eclipse</a></p></li>
</ul>
</li>
</ul>
</li>
<li><p><a class="reference internal" href="#structuring" id="id27">3. Structuring</a></p>
<ul>
<li><p><a class="reference internal" href="#classes-and-api" id="id28">3.1. Classes and API</a></p></li>
<li><p><a class="reference internal" href="#passing-arguments" id="id29">3.2. Passing arguments</a></p></li>
</ul>
</li>
</ul>
</div>
...
<h4>2.6.1. Emacs</h4>
<p>You can use the following <a class="reference external" href="https://raw.githubusercontent.com/PointCloudLibrary/pcl/master/doc/advanced/content/files/pcl-c-style.el">PCL C/C++ style file</a>,
download it to some known location and then:</p>
<ul class="simple">
<li><p>open .emacs</p></li>
<li><p>add the following before any C/C++ custom hooks</p></li>
</ul>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="p">(</span><span class="n">load</span><span class="o">-</span><span class="n">file</span> <span class="s2">&quot;/location/to/pcl-c-style.el&quot;</span><span class="p">)</span>
<span class="p">(</span><span class="n">add</span><span class="o">-</span><span class="n">hook</span> <span class="s1">&#39;c-mode-common-hook &#39;</span><span class="n">pcl</span><span class="o">-</span><span class="nb">set</span><span class="o">-</span><span class="n">c</span><span class="o">-</span><span class="n">style</span><span class="p">)</span>
</pre></div>
</div>
</div>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">PCL_ERROR</span><span class="p">(</span><span class="s">&quot;Text</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">);</span>
</pre></div>
</div>
<p>should be</p>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">PCL_ERROR</span> <span class="p">(</span><span class="s">&quot;Text</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">);</span>
...
<p>This style sheet is not perfect, please mention errors on the user mailing list and feel free to patch!</p>
</div>
</div>
</div>
</div>
