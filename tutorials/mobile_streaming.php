...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Point Cloud Streaming to Mobile Devices with Real-time Visualization &#8212; PCL 0.0 documentation</title>
...
The server program uses the <code class="docutils literal notranslate"><span class="pre">pcl::OpenNIGrabber</span></code> to generate point clouds from an
OpenNI compatible camera.  The tutorial <a class="reference internal" href="openni_grabber.php#openni-grabber"><span class="std std-ref">The OpenNI Grabber Framework in PCL</span></a> provides a background
for working with the <code class="docutils literal notranslate"><span class="pre">pcl::OpenNIGrabber</span></code>.  This tutorial describes the client and server
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ./bin/pcl_openni_mobile_server -p 11111
</pre></div>
</div>
...
scripts in order:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ./configure_cmake.sh
$ ./configure_ant.sh
$ ./compile.sh
$ ./install.sh
</pre></div>
...
<p>Note, the app will not overwrite <em>appConfig.txt</em> on the SD card if it already exists.</p>
</div>
...
The first object to be initialized is the <code class="docutils literal notranslate"><span class="pre">pcl::OpenNIGrabber</span></code>.  The grabber is
used to generate point clouds from an OpenNI compatible camera.  Here are the first
few lines of the <em>run()</em> method:</p>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">pcl</span><span class="o">::</span><span class="n">OpenNIGrabber</span> <span class="n">grabber</span> <span class="p">(</span><span class="n">device_id_</span><span class="p">);</span>
<span class="n">std</span><span class="o">::</span><span class="n">function</span><span class="o">&lt;</span><span class="kt">void</span> <span class="p">(</span><span class="k">const</span> <span class="n">CloudConstPtr</span><span class="o">&amp;</span><span class="p">)</span><span class="o">&gt;</span> <span class="n">handler_function</span> <span class="o">=</span> <span class="p">[</span><span class="k">this</span><span class="p">]</span> <span class="p">(</span><span class="k">const</span> <span class="n">CloudConstPtr</span><span class="o">&amp;</span> <span class="n">cloud</span><span class="p">)</span> <span class="p">{</span> <span class="n">handleIncomingCloud</span> <span class="p">(</span><span class="n">cloud</span><span class="p">);</span> <span class="p">};</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">struct</span> <span class="n">PointCloudBuffers</span>
<span class="p">{</span>
  <span class="k">typedef</span> <span class="n">pcl</span><span class="o">::</span><span class="n">shared_ptr</span><span class="o">&lt;</span><span class="n">PointCloudBuffers</span><span class="o">&gt;</span> <span class="n">Ptr</span><span class="p">;</span>
...
by the <code class="docutils literal notranslate"><span class="pre">pcl::OpenNIGrabber</span></code> will have units in meters and the extent of the point
...
<span class="p">{</span>
  <span class="k">const</span> <span class="n">std</span><span class="o">::</span><span class="kt">size_t</span> <span class="n">nr_points</span> <span class="o">=</span> <span class="n">cloud</span><span class="o">-&gt;</span><span class="n">points</span><span class="p">.</span><span class="n">size</span> <span class="p">();</span>
  ...
  <span class="n">std</span><span class="o">::</span><span class="kt">size_t</span> <span class="n">j</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
  <span class="k">for</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="kt">size_t</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">nr_points</span><span class="p">;</span> <span class="o">++</span><span class="n">i</span><span class="p">)</span>
  <span class="p">{</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">boost</span><span class="o">::</span><span class="n">asio</span><span class="o">::</span><span class="n">io_service</span> <span class="n">io_service</span><span class="p">;</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">while</span> <span class="p">(</span><span class="o">!</span><span class="n">viewer_</span><span class="p">.</span><span class="n">wasStopped</span> <span class="p">())</span>
<span class="p">{</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="c1">// wait for client</span>
<span class="kt">unsigned</span> <span class="kt">int</span> <span class="n">nr_points</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
<span class="n">boost</span><span class="o">::</span><span class="n">asio</span><span class="o">::</span><span class="n">read</span> <span class="p">(</span><span class="n">socket</span><span class="p">,</span> <span class="n">boost</span><span class="o">::</span><span class="n">asio</span><span class="o">::</span><span class="n">buffer</span> <span class="p">(</span><span class="o">&amp;</span><span class="n">nr_points</span><span class="p">,</span> <span class="k">sizeof</span> <span class="p">(</span><span class="n">nr_points</span><span class="p">)));</span>
</pre></div>
</div>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">PointCloudBuffers</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">buffers_to_send</span> <span class="o">=</span> <span class="n">getLatestBuffers</span> <span class="p">();</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">if</span> <span class="p">(</span><span class="n">nr_points</span><span class="p">)</span>
<span class="p">{</span>
  <span class="n">boost</span><span class="o">::</span><span class="n">asio</span><span class="o">::</span><span class="n">write</span> <span class="p">(</span><span class="n">socket</span><span class="p">,</span> <span class="n">boost</span><span class="o">::</span><span class="n">asio</span><span class="o">::</span><span class="n">buffer</span> <span class="p">(</span><span class="o">&amp;</span><span class="n">buffers_to_send</span><span class="o">-&gt;</span><span class="n">points</span><span class="p">.</span><span class="n">front</span><span class="p">(),</span> <span class="n">nr_points</span> <span class="o">*</span> <span class="mi">3</span> <span class="o">*</span> <span class="k">sizeof</span> <span class="p">(</span><span class="kt">short</span><span class="p">)));</span>
  <span class="n">boost</span><span class="o">::</span><span class="n">asio</span><span class="o">::</span><span class="n">write</span> <span class="p">(</span><span class="n">socket</span><span class="p">,</span> <span class="n">boost</span><span class="o">::</span><span class="n">asio</span><span class="o">::</span><span class="n">buffer</span> <span class="p">(</span><span class="o">&amp;</span><span class="n">buffers_to_send</span><span class="o">-&gt;</span><span class="n">rgb</span><span class="p">.</span><span class="n">front</span><span class="p">(),</span> <span class="n">nr_points</span> <span class="o">*</span> <span class="mi">3</span> <span class="o">*</span> <span class="k">sizeof</span> <span class="p">(</span><span class="kt">unsigned</span> <span class="kt">char</span><span class="p">)));</span>
<span class="p">}</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="kt">void</span> <span class="nf">willRender</span><span class="p">()</span>
<span class="p">{</span>
...
in a new thread:</p>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">this</span><span class="o">-&gt;</span><span class="n">Internal</span><span class="o">-&gt;</span><span class="n">ClientThreadId</span> <span class="o">=</span> <span class="k">this</span><span class="o">-&gt;</span><span class="n">Internal</span><span class="o">-&gt;</span><span class="n">MultiThreader</span><span class="o">-&gt;</span><span class="n">SpawnThread</span><span class="p">(</span><span class="n">ClientLoop</span><span class="p">,</span> <span class="k">this</span><span class="o">-&gt;</span><span class="n">Internal</span><span class="p">);</span>
</pre></div>
</div>
...
the client loop:</p>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">VTK_THREAD_RETURN_TYPE</span> <span class="nf">ClientLoop</span><span class="p">(</span><span class="kt">void</span><span class="o">*</span> <span class="n">arg</span><span class="p">)</span>
<span class="p">{</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">vesGeometryData</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">ReceiveGeometryData</span><span class="p">(</span><span class="n">vtkClientSocket</span><span class="o">*</span> <span class="n">comm</span><span class="p">)</span>
<span class="p">{</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="kt">int</span> <span class="n">numberOfPoints</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">if</span> <span class="p">(</span><span class="o">!</span><span class="n">numberOfPoints</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="n">vesGeometryData</span><span class="o">::</span><span class="n">Ptr</span><span class="p">(</span><span class="k">new</span> <span class="n">vesGeometryData</span><span class="p">);</span>
<span class="p">}</span>
</pre></div>
</div>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="n">points</span><span class="o">-&gt;</span><span class="n">SetNumberOfTuples</span><span class="p">(</span><span class="n">numberOfPoints</span><span class="o">*</span><span class="mi">3</span><span class="p">);</span>
<span class="n">colors</span><span class="o">-&gt;</span><span class="n">SetNumberOfComponents</span><span class="p">(</span><span class="mi">3</span><span class="p">);</span>
<span class="n">colors</span><span class="o">-&gt;</span><span class="n">SetNumberOfTuples</span><span class="p">(</span><span class="n">numberOfPoints</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="kt">void</span> <span class="n">vesKiwiStreamingDataRepresentation</span><span class="o">::</span><span class="n">willRender</span><span class="p">(</span><span class="n">vesSharedPtr</span><span class="o">&lt;</span><span class="n">vesRenderer</span><span class="o">&gt;</span> <span class="n">renderer</span><span class="p">)</span>
<span class="p">{</span>
