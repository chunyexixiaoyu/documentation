...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Tracking object in real time &#8212; PCL 0.0 documentation</title>
...
<p class="caption"><span class="caption-text">fig1: The blue model tracks the cup successfully with red particles.</span></p>
</div>
</div>
...
<p class="caption"><span class="caption-text">fig2: The process of tracking Particle Filter</span></p>
</div>
</div>
...
286
287
288</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cp">#include</span> <span class="cpf">&lt;pcl/point_cloud.h&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/common/centroid.h&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/filters/approximate_voxel_grid.h&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/search/pcl_search.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/common/transforms.h&gt;</span><span class="cp"></span>

<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/tracking.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/particle_filter.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/kld_adaptive_particle_filter_omp.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/particle_filter_omp.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/coherence.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/distance_coherence.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/hsv_color_coherence.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/approx_nearest_pair_point_cloud_coherence.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/tracking/nearest_pair_point_cloud_coherence.h&gt;</span><span class="cp"></span>

<span class="cp">#include</span> <span class="cpf">&lt;boost/format.hpp&gt;</span><span class="cp"></span>
...
<span class="n">ParticleFilter</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">tracker_</span><span class="p">;</span>
...
<span class="p">{</span>
  ...
  <span class="k">if</span> <span class="p">(</span><span class="n">particles</span> <span class="o">&amp;&amp;</span> <span class="n">new_cloud_</span><span class="p">)</span>
    <span class="p">{</span>
      ...
      <span class="k">for</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="kt">size_t</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">particles</span><span class="o">-&gt;</span><span class="n">points</span><span class="p">.</span><span class="n">size</span> <span class="p">();</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span>
	<span class="p">{</span>
...
<span class="p">{</span>
  ...
  <span class="n">KLDAdaptiveParticleFilterOMPTracker</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="p">,</span> <span class="n">ParticleT</span><span class="o">&gt;::</span><span class="n">Ptr</span> <span class="n">tracker</span>
  ...
  <span class="n">ApproxNearestPairPointCloudCoherence</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="o">&gt;::</span><span class="n">Ptr</span> <span class="n">coherence</span>
  ...
  <span class="n">DistanceCoherence</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="o">&gt;::</span><span class="n">Ptr</span> <span class="n">distance_coherence</span>
    <span class="p">(</span><span class="k">new</span> <span class="n">DistanceCoherence</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="o">&gt;</span><span class="p">);</span>
  ...
  <span class="n">pcl</span><span class="o">::</span><span class="n">search</span><span class="o">::</span><span class="n">Octree</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="o">&gt;::</span><span class="n">Ptr</span> <span class="n">search</span> <span class="p">(</span><span class="k">new</span> <span class="n">pcl</span><span class="o">::</span><span class="n">search</span><span class="o">::</span><span class="n">Octree</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="o">&gt;</span> <span class="p">(</span><span class="mf">0.01</span><span class="p">));</span>
  ...
  <span class="n">std</span><span class="o">::</span><span class="n">function</span><span class="o">&lt;</span><span class="kt">void</span> <span class="p">(</span><span class="k">const</span> <span class="n">CloudConstPtr</span><span class="o">&amp;</span><span class="p">)</span><span class="o">&gt;</span> <span class="n">f</span> <span class="o">=</span> <span class="n">cloud_cb</span><span class="p">;</span>
  ...
  <span class="n">viewer_</span><span class="o">-&gt;</span><span class="n">runOnVisualizationThread</span> <span class="p">(</span><span class="n">viz_cb</span><span class="p">,</span> <span class="s">&quot;viz_cb&quot;</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="c1">//Set all parameters for  KLDAdaptiveParticleFilterOMPTracker</span>
  <span class="n">tracker</span><span class="o">-&gt;</span><span class="n">setMaximumParticleNum</span> <span class="p">(</span><span class="mi">1000</span><span class="p">);</span>
  <span class="n">tracker</span><span class="o">-&gt;</span><span class="n">setDelta</span> <span class="p">(</span><span class="mf">0.99</span><span class="p">);</span>
  <span class="n">tracker</span><span class="o">-&gt;</span><span class="n">setEpsilon</span> <span class="p">(</span><span class="mf">0.2</span><span class="p">);</span>
  <span class="n">tracker</span><span class="o">-&gt;</span><span class="n">setBinSize</span> <span class="p">(</span><span class="n">bin_size</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="c1">//Setup coherence object for tracking</span>
  <span class="n">ApproxNearestPairPointCloudCoherence</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="o">&gt;::</span><span class="n">Ptr</span> <span class="n">coherence</span>
    <span class="p">(</span><span class="k">new</span> <span class="n">ApproxNearestPairPointCloudCoherence</span><span class="o">&lt;</span><span class="n">RefPointType</span><span class="o">&gt;</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="c1">//prepare the model of tracker&#39;s target</span>
  <span class="n">Eigen</span><span class="o">::</span><span class="n">Vector4f</span> <span class="n">c</span><span class="p">;</span>
  <span class="n">Eigen</span><span class="o">::</span><span class="n">Affine3f</span> <span class="n">trans</span> <span class="o">=</span> <span class="n">Eigen</span><span class="o">::</span><span class="n">Affine3f</span><span class="o">::</span><span class="n">Identity</span> <span class="p">();</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="k">if</span><span class="p">(</span><span class="n">counter</span> <span class="o">&lt;</span> <span class="mi">10</span><span class="p">){</span>
	<span class="n">counter</span><span class="o">++</span><span class="p">;</span>
  <span class="p">}</span><span class="k">else</span><span class="p">{</span>
  	<span class="c1">//Track the object</span>
	<span class="n">tracker_</span><span class="o">-&gt;</span><span class="n">setInputCloud</span> <span class="p">(</span><span class="n">cloud_pass_downsampled_</span><span class="p">);</span>
...
<li><p>Output only target point cloud with your other code (See <a class="reference internal" href="planar_segmentation.php#planar-segmentation"><span class="std std-ref">Plane model segmentation</span></a> tutorial) and save as tracking_target.pcd</p></li>
</ol>
</div></blockquote>
