...
<p>Don’t forget that all the dependencies must be compiled using the same
...
<blockquote>
<div><ul class="simple">
<li><p><strong>Boost</strong> version &gt;= 1.46.1 (<a class="reference external" href="http://www.boost.org/">http://www.boost.org/</a>)</p></li>
</ul>
<p>used for shared pointers, and threading. <strong>mandatory</strong></p>
<ul class="simple">
<li><p><strong>Eigen</strong> version &gt;= 3.0.0 (<a class="reference external" href="http://eigen.tuxfamily.org/">http://eigen.tuxfamily.org/</a>)</p></li>
</ul>
<p>used as the matrix backend for SSE optimized math. <strong>mandatory</strong></p>
<ul class="simple">
<li><p><strong>FLANN</strong> version &gt;= 1.6.8 (<a class="reference external" href="http://www.cs.ubc.ca/research/flann/">http://www.cs.ubc.ca/research/flann/</a>)</p></li>
</ul>
<p>used in <cite>kdtree</cite> for fast approximate nearest neighbors search. <strong>mandatory</strong></p>
<ul class="simple">
<li><p><strong>Visualization ToolKit (VTK)</strong> version &gt;= 5.6.1 (<a class="reference external" href="http://www.vtk.org/">http://www.vtk.org/</a>)</p></li>
</ul>
<p>used in <cite>visualization</cite> for 3D point cloud rendering and visualization. <strong>mandatory</strong></p>
<ul class="simple">
<li><p><strong>googletest</strong> version &gt;= 1.6.0 (<a class="reference external" href="http://code.google.com/p/googletest/">http://code.google.com/p/googletest/</a>)</p></li>
</ul>
<p>used to build test units. <strong>optional</strong></p>
<ul class="simple">
<li><p><strong>QHULL</strong> version &gt;= 2011.1 (<a class="reference external" href="http://www.qhull.org/">http://www.qhull.org/</a>)</p></li>
</ul>
<p>used for convex/concave hull decompositions in <cite>surface</cite>. <strong>optional</strong></p>
<ul class="simple">
<li><p><strong>OpenNI</strong> version &gt;= 1.1.0.25 (<a class="reference external" href="http://www.openni.org/">http://www.openni.org/</a>)</p></li>
</ul>
<p>used to grab point clouds from OpenNI compliant devices. <strong>optional</strong></p>
<ul class="simple">
<li><p><strong>Qt</strong> version &gt;= 4.6 (<a class="reference external" href="http://qt.digia.com/">http://qt.digia.com/</a>)</p></li>
</ul>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Name</span>  <span class="p">:</span> <span class="n">BOOST_TOOLSET</span>
<span class="n">Type</span>  <span class="p">:</span> <span class="n">STRING</span>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you want to build 64 bit libraries, then choose “Visual Studio 9 2008 Win64” as generator.</p>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you get some errors during the installation process, it could be caused by the UAC of MS Windows
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you don’t have a Python interpreter installed CMake would probably not allow you
...
<div><div class="admonition note">
<p class="admonition-title">Note</p>
<p>If you want to build PCL GUI tools, you need to build VTK with Qt support, so obviously, you need to build/install Qt before VTK.</p>
</div>
...
<h1>Building PCL</h1>
<p>Now that you built and installed PCL dependencies, you can follow the “<a class="reference internal" href="compiling_pcl_windows.php#compiling-pcl-windows"><span class="std std-ref">Compiling PCL from source on Windows</span></a>” tutorial
