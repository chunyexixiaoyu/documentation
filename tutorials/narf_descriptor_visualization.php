...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Visualization of the NARF descriptor and descriptor distances &#8212; PCL 0.0 documentation</title>
...
<h1>The code</h1>
<p>First, create a file called, let’s say, <code class="docutils literal notranslate"><span class="pre">narf_descriptor_visualization.cpp</span></code> in your favorite
...
241
242
243</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cm">/* \author Bastian Steder */</span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/features/narf.h&gt;</span><span class="cp"></span>
  ...
  <span class="p">{</span>
    ...
    <span class="p">{</span>
      ...
      <span class="c1">//surface_patch_widget.markLine (patch_middle, patch_middle, patch_middle+line_length*sinf (angle),</span>
                                     <span class="c1">//patch_middle+line_length*-std::cos (angle), pcl::visualization::Vector3ub (0,255,0));</span>
    <span class="p">}</span>
    ...
    <span class="p">{</span>
      <span class="c1">//surface_patch_widget.markLine (radius-0.5, radius-0.5, radius-0.5f + 2.0f*radius*sinf (rotations[i]),</span>
                                                <span class="c1">//radius-0.5f - 2.0f*radius*std::cos (rotations[i]), pcl::visualization::Vector3ub (255,0,0));</span>
    <span class="p">}</span>
