...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Conditional Euclidean Clustering &#8212; PCL 0.0 documentation</title>
...
<p>This class uses the same greedy-like / region-growing / flood-filling approach that is used in <a class="reference internal" href="cluster_extraction.php#cluster-extraction"><span class="std std-ref">Euclidean Cluster Extraction</span></a>, <a class="reference internal" href="region_growing_segmentation.php#region-growing-segmentation"><span class="std std-ref">Region growing segmentation</span></a> and <a class="reference internal" href="region_growing_rgb_segmentation.php#region-growing-rgb-segmentation"><span class="std std-ref">Color-based region growing segmentation</span></a>.
...
<p>The <a class="reference internal" href="cluster_extraction.php#cluster-extraction"><span class="std std-ref">Euclidean Cluster Extraction</span></a> and <a class="reference internal" href="region_growing_segmentation.php#region-growing-segmentation"><span class="std std-ref">Region growing segmentation</span></a> tutorials already explain the region growing algorithm very accurately.
...
115
116
117</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cp">#include</span> <span class="cpf">&lt;pcl/point_types.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/io/pcd_io.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/console/time.h&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/segmentation/conditional_euclidean_clustering.h&gt;</span><span class="cp"></span>
...
<span class="p">{</span>
  <span class="n">Eigen</span><span class="o">::</span><span class="n">Map</span><span class="o">&lt;</span><span class="k">const</span> <span class="n">Eigen</span><span class="o">::</span><span class="n">Vector3f</span><span class="o">&gt;</span> <span class="n">point_a_normal</span> <span class="o">=</span> <span class="n">point_a</span><span class="p">.</span><span class="n">getNormalVector3fMap</span> <span class="p">(),</span> <span class="n">point_b_normal</span> <span class="o">=</span> <span class="n">point_b</span><span class="p">.</span><span class="n">getNormalVector3fMap</span> <span class="p">();</span>
  <span class="k">if</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">abs</span> <span class="p">(</span><span class="n">point_a</span><span class="p">.</span><span class="n">intensity</span> <span class="o">-</span> <span class="n">point_b</span><span class="p">.</span><span class="n">intensity</span><span class="p">)</span> <span class="o">&lt;</span> <span class="mf">5.0f</span><span class="p">)</span>
    <span class="k">return</span> <span class="p">(</span><span class="nb">true</span><span class="p">);</span>
  <span class="k">if</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">abs</span> <span class="p">(</span><span class="n">point_a_normal</span><span class="p">.</span><span class="n">dot</span> <span class="p">(</span><span class="n">point_b_normal</span><span class="p">))</span> <span class="o">&lt;</span> <span class="mf">0.05</span><span class="p">)</span>
    <span class="k">return</span> <span class="p">(</span><span class="nb">true</span><span class="p">);</span>
  <span class="k">return</span> <span class="p">(</span><span class="nb">false</span><span class="p">);</span>
<span class="p">}</span>
...
<span class="p">{</span>
  ...
  <span class="p">{</span>
    <span class="k">if</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">abs</span> <span class="p">(</span><span class="n">point_a</span><span class="p">.</span><span class="n">intensity</span> <span class="o">-</span> <span class="n">point_b</span><span class="p">.</span><span class="n">intensity</span><span class="p">)</span> <span class="o">&lt;</span> <span class="mf">8.0f</span><span class="p">)</span>
      <span class="k">return</span> <span class="p">(</span><span class="nb">true</span><span class="p">);</span>
    <span class="k">if</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">abs</span> <span class="p">(</span><span class="n">point_a_normal</span><span class="p">.</span><span class="n">dot</span> <span class="p">(</span><span class="n">point_b_normal</span><span class="p">))</span> <span class="o">&lt;</span> <span class="mf">0.06</span><span class="p">)</span>
      <span class="k">return</span> <span class="p">(</span><span class="nb">true</span><span class="p">);</span>
  <span class="p">}</span>
  <span class="k">else</span>
  <span class="p">{</span>
...
<li><p><a class="reference internal" href="voxel_grid.php#voxelgrid"><span class="std std-ref">Downsampling a PointCloud using a VoxelGrid filter</span></a> is being used (lines 66-73) to downsample the cloud and give a more equalized point density.</p></li>
<li><p><a class="reference internal" href="normal_estimation.php#normal-estimation"><span class="std std-ref">Estimating Surface Normals in a PointCloud</span></a> is being used (lines 75-83)  to estimate normals which will be appended to the point information;
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="c1">// Set up a Conditional Euclidean Clustering class</span>
  <span class="n">std</span><span class="o">::</span><span class="n">cerr</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Segmenting to clusters...</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">,</span> <span class="n">tt</span><span class="p">.</span><span class="n">tic</span> <span class="p">();</span>
  <span class="n">pcl</span><span class="o">::</span><span class="n">ConditionalEuclideanClustering</span><span class="o">&lt;</span><span class="n">PointTypeFull</span><span class="o">&gt;</span> <span class="n">cec</span> <span class="p">(</span><span class="nb">true</span><span class="p">);</span>
  <span class="n">cec</span><span class="p">.</span><span class="n">setInputCloud</span> <span class="p">(</span><span class="n">cloud_with_normals</span><span class="p">);</span>
  <span class="n">cec</span><span class="p">.</span><span class="n">setConditionFunction</span> <span class="p">(</span><span class="o">&amp;</span><span class="n">customRegionGrowing</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="kt">bool</span>
<span class="nf">enforceIntensitySimilarity</span> <span class="p">(</span><span class="k">const</span> <span class="n">PointTypeFull</span><span class="o">&amp;</span> <span class="n">point_a</span><span class="p">,</span> <span class="k">const</span> <span class="n">PointTypeFull</span><span class="o">&amp;</span> <span class="n">point_b</span><span class="p">,</span> <span class="kt">float</span> <span class="n">squared_distance</span><span class="p">)</span>
<span class="p">{</span>
  <span class="k">if</span> <span class="p">(</span><span class="n">std</span><span class="o">::</span><span class="n">abs</span> <span class="p">(</span><span class="n">point_a</span><span class="p">.</span><span class="n">intensity</span> <span class="o">-</span> <span class="n">point_b</span><span class="p">.</span><span class="n">intensity</span><span class="p">)</span> <span class="o">&lt;</span> <span class="mf">5.0f</span><span class="p">)</span>
    <span class="k">return</span> <span class="p">(</span><span class="nb">true</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="c1">// Using the intensity channel for lazy visualization of the output</span>
  <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">small_clusters</span><span class="o">-&gt;</span><span class="n">size</span> <span class="p">();</span> <span class="o">++</span><span class="n">i</span><span class="p">)</span>
    <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">j</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">j</span> <span class="o">&lt;</span> <span class="p">(</span><span class="o">*</span><span class="n">small_clusters</span><span class="p">)[</span><span class="n">i</span><span class="p">].</span><span class="n">indices</span><span class="p">.</span><span class="n">size</span> <span class="p">();</span> <span class="o">++</span><span class="n">j</span><span class="p">)</span>
      <span class="n">cloud_out</span><span class="o">-&gt;</span><span class="n">points</span><span class="p">[(</span><span class="o">*</span><span class="n">small_clusters</span><span class="p">)[</span><span class="n">i</span><span class="p">].</span><span class="n">indices</span><span class="p">[</span><span class="n">j</span><span class="p">]].</span><span class="n">intensity</span> <span class="o">=</span> <span class="o">-</span><span class="mf">2.0</span><span class="p">;</span>
  <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">large_clusters</span><span class="o">-&gt;</span><span class="n">size</span> <span class="p">();</span> <span class="o">++</span><span class="n">i</span><span class="p">)</span>
