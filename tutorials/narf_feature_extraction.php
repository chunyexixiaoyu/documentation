...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>How to extract NARF Features from a range image &#8212; PCL 0.0 documentation</title>
...
217
218
219</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cm">/* \author Bastian Steder */</span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/features/narf_descriptor.h&gt;</span><span class="cp"></span>
...
<span class="kt">bool</span> <span class="n">rotation_invariant</span> <span class="o">=</span> <span class="nb">true</span><span class="p">;</span>
...
<span class="p">{</span>
  <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;</span><span class="se">\n\n</span><span class="s">Usage: &quot;</span><span class="o">&lt;&lt;</span><span class="n">progName</span><span class="o">&lt;&lt;</span><span class="s">&quot; [options] &lt;scene.pcd&gt;</span><span class="se">\n\n</span><span class="s">&quot;</span>
            ...
            <span class="o">&lt;&lt;</span> <span class="s">&quot;-s &lt;float&gt;   support size for the interest points (diameter of the used sphere - &quot;</span>
                                                                  <span class="s">&quot;default &quot;</span><span class="o">&lt;&lt;</span><span class="n">support_size</span><span class="o">&lt;&lt;</span><span class="s">&quot;)</span><span class="se">\n</span><span class="s">&quot;</span>
...
<span class="p">{</span>
  ...
  <span class="n">pcl</span><span class="o">::</span><span class="n">NarfKeypoint</span> <span class="n">narf_keypoint_detector</span><span class="p">;</span>
  <span class="n">narf_keypoint_detector</span><span class="p">.</span><span class="n">setRangeImageBorderExtractor</span> <span class="p">(</span><span class="o">&amp;</span><span class="n">range_image_border_extractor</span><span class="p">);</span>
  ...
  <span class="c1">// ------------------------------------------------------</span>
  <span class="c1">// -----Extract NARF descriptors for interest points-----</span>
  <span class="c1">// ------------------------------------------------------</span>
  ...
  <span class="n">std</span><span class="o">::</span><span class="n">cout</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;Extracted &quot;</span><span class="o">&lt;&lt;</span><span class="n">narf_descriptors</span><span class="p">.</span><span class="n">size</span> <span class="p">()</span><span class="o">&lt;&lt;</span><span class="s">&quot; descriptors for &quot;</span>
                      <span class="o">&lt;&lt;</span><span class="n">keypoint_indices</span><span class="p">.</span><span class="n">points</span><span class="p">.</span><span class="n">size</span> <span class="p">()</span><span class="o">&lt;&lt;</span> <span class="s">&quot; keypoints.</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">;</span>
...
<span class="nb">project</span><span class="p">(</span><span class="s">narf_feature_extraction</span><span class="p">)</span>
...
<span class="nb">add_executable</span> <span class="p">(</span><span class="s">narf_feature_extraction</span> <span class="s">narf_feature_extraction.cpp</span><span class="p">)</span>
<span class="nb">target_link_libraries</span> <span class="p">(</span><span class="s">narf_feature_extraction</span> <span class="o">${</span><span class="nv">PCL_LIBRARIES</span><span class="o">}</span><span class="p">)</span>
</pre></div>
</td></tr></table></div>
