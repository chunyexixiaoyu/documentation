...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>How to visualize a range image &#8212; PCL 0.0 documentation</title>
...
<h1>The code</h1>
<p>First, create a file called, let’s say, <code class="docutils literal notranslate"><span class="pre">range_image_visualization.cpp</span></code> in your favorite
...
163
164
165</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cp">#include</span> <span class="cpf">&lt;iostream&gt;</span><span class="cp"></span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ./range_image_visualization
</pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ./range_image_visualization &lt;point_cloud.pcd&gt;
</pre></div>
</div>
<p>You can also try the -l parameter to update the range image according to the current perspective in the viewer:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>$ ./range_image_visualization -l &lt;point_cloud.pcd&gt;
</pre></div>
</div>
