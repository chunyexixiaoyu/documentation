...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Adding your own custom PointT type &#8212; PCL 0.0 documentation</title>
...
<ul class="simple">
<li><p><a class="reference internal" href="#adding-your-own-custom-pointt-type" id="id1">Adding your own custom <cite>PointT</cite> type</a></p></li>
<li><p><a class="reference internal" href="#why-pointt-types" id="id2">Why <cite>PointT</cite> types</a></p></li>
<li><p><a class="reference internal" href="#what-pointt-types-are-available-in-pcl" id="id3">What <cite>PointT</cite> types are available in PCL?</a></p></li>
<li><p><a class="reference internal" href="#how-are-the-point-types-exposed" id="id4">How are the point types exposed?</a></p></li>
<li><p><a class="reference internal" href="#how-to-add-a-new-pointt-type" id="id5">How to add a new <cite>PointT</cite> type</a></p></li>
<li><p><a class="reference internal" href="#example" id="id6">Example</a></p></li>
</ul>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The current document is valid only for PCL 0.x and 1.x. Note that at the time
...
5
6
7</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="k">struct</span> <span class="n">PointXYZ</span>
<span class="p">{</span>
...
<cite>XYZ</cite> 3D data, <cite>RGBA</cite> information (colors), and surface normals estimated at
...
<ul>
<li><p><cite>PointXYZ</cite> - Members: float x, y, z;</p>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">union</span>
<span class="p">{</span>
...
<ul>
<li><p><cite>PointXYZI</cite> - Members: float x, y, z, intensity;</p>
...
<ul>
<li><p><cite>PointXYZRGBA</cite> - Members: float x, y, z; std::uint32_t rgba;</p>
<p>Similar to <cite>PointXYZI</cite>, except <cite>rgba</cite> contains the RGBA information packed
into an unsigned 32-bit integer. Thanks to the <cite>union</cite> declaration, it is
also possible to access color channels individually by name.</p>
</li>
</ul>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The nested <cite>union</cite> declaration provides yet another way to look at the RGBA
data–as a single precision floating point number. This is present for
historical reasons and should not be used in new code.</p>
</div>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">union</span>
<span class="p">{</span>
  <span class="kt">float</span> <span class="n">data</span><span class="p">[</span><span class="mi">4</span><span class="p">];</span>
...
<ul>
<li><p><cite>PointXYZRGB</cite> - float x, y, z; std::uint32_t rgba;</p>
<p>Same as <cite>PointXYZRGBA</cite>.</p>
</li>
<li><p><cite>PointXY</cite> - float x, y;</p>
<p>Simple 2D x-y point structure.</p>
</li>
</ul>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">struct</span>
<span class="p">{</span>
  <span class="kt">float</span> <span class="n">x</span><span class="p">;</span>
  <span class="kt">float</span> <span class="n">y</span><span class="p">;</span>
<span class="p">};</span>
...
<ul>
<li><p><cite>InterestPoint</cite> - float x, y, z, strength;</p>
<p>Similar to <cite>PointXYZI</cite>, except <cite>strength</cite> contains a measure of the strength
of the keypoint.</p>
</li>
</ul>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">union</span>
...
<ul>
<li><p><cite>Normal</cite> - float normal[3], curvature;</p>
...
<ul>
<li><p><cite>PointNormal</cite> - float x, y, z; float normal[3], curvature;</p>
...
<ul>
<li><p><cite>PointXYZRGBNormal</cite> - float x, y, z, normal[3], curvature; std::uint32_t rgba;</p>
<p>A point structure that holds XYZ data, and RGBA colors, together with surface
normals and curvatures.</p>
</li>
</ul>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Despite the name, this point type does contain the alpha color channel.</p>
</div>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">union</span>
<span class="p">{</span>
  <span class="kt">float</span> <span class="n">data</span><span class="p">[</span><span class="mi">4</span><span class="p">];</span>
...
<ul>
<li><p><cite>PointXYZINormal</cite> - float x, y, z, intensity, normal[3], curvature;</p>
...
<ul>
<li><p><cite>PointWithRange</cite> - float x, y, z (union with float point[4]), range;</p>
<p>Similar to <cite>PointXYZI</cite>, except <cite>range</cite> contains a measure of the distance
from the acquisition viewpoint to the point in the world.</p>
</li>
</ul>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">union</span>
<span class="p">{</span>
...
<ul>
<li><p><cite>PointWithViewpoint</cite> - float x, y, z, vp_x, vp_y, vp_z;</p>
<p>Similar to <cite>PointXYZI</cite>, except <cite>vp_x</cite>, <cite>vp_y</cite>, and <cite>vp_z</cite> contain the
...
<ul>
<li><p><cite>MomentInvariants</cite> - float j1, j2, j3;</p>
...
<ul>
<li><p><cite>PrincipalRadiiRSD</cite> - float r_min, r_max;</p>
...
<ul>
<li><p><cite>Boundary</cite> - std::uint8_t boundary_point;</p>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">struct</span>
<span class="p">{</span>
  <span class="n">std</span><span class="o">::</span><span class="kt">uint8_t</span> <span class="n">boundary_point</span><span class="p">;</span>
<span class="p">};</span>
</pre></div>
</div>
<ul>
<li><p><cite>PrincipalCurvatures</cite> - float principal_curvature[3], pc1, pc2;</p>
...
<ul>
<li><p><cite>PFHSignature125</cite> - float pfh[125];</p>
...
<ul>
<li><p><cite>FPFHSignature33</cite> - float fpfh[33];</p>
...
<ul>
<li><p><cite>VFHSignature308</cite> - float vfh[308];</p>
...
<ul>
<li><p><cite>Narf36</cite> - float x, y, z, roll, pitch, yaw; float descriptor[36];</p>
...
<ul>
<li><p><cite>BorderDescription</cite> - int x, y; BorderTraits traits;</p>
...
<ul>
<li><p><cite>IntensityGradient</cite> - float gradient[3];</p>
...
<ul>
<li><p><cite>Histogram</cite> - float histogram[N];</p>
<blockquote>
<div><p>General purpose n-D histogram placeholder.</p>
</div></blockquote>
</li>
</ul>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">template</span> <span class="o">&lt;</span><span class="kt">int</span> <span class="n">N</span><span class="o">&gt;</span>
...
<ul>
<li><p><cite>PointWithScale</cite> - float x, y, z, scale;</p>
<p>Similar to <cite>PointXYZI</cite>, except <cite>scale</cite> contains the scale at which a certain
...
<ul>
<li><p><cite>PointSurfel</cite> - float x, y, z, normal[3], rgba, radius, confidence, curvature;</p>
...
13
14
15</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="c1">// foo.h</span>
...
13
14
15</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="c1">// impl/foo.hpp</span>
...
7
8
9</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="c1">// foo.cpp</span>
...
<span class="cp">#include</span> <span class="cpf">&quot;foo.h&quot;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&quot;impl/foo.hpp&quot;</span><span class="cp"></span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="c1">// PCL_INSTANTIATE: call to instantiate template TEMPLATE for all</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="c1">// Define all point types that include XYZ data</span>
...
6
7
8</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="c1">// foo.cpp</span>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>For more information about explicit instantiations, please see <em>C++ Templates
...
2
3
4</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="k">struct</span> <span class="n">MyPointType</span>
<span class="p">{</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="cp">#define PCL_NO_PRECOMPILE</span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/filters/passthrough.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/filters/impl/passthrough.hpp&gt;</span><span class="cp"></span>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>Starting with PCL-1.7 you need to define PCL_NO_PRECOMPILE before you include
...
34
35
36</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cp">#define PCL_NO_PRECOMPILE</span>
...
<span class="p">{</span>
  ...
  <span class="kt">float</span> <span class="n">test</span><span class="p">;</span>
  <span class="n">PCL_MAKE_ALIGNED_OPERATOR_NEW</span>     <span class="c1">// make sure our new allocators are aligned</span>
