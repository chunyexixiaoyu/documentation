...
<p>For more information, including the mathematical equations of the least-squares problem, see <a class="reference internal" href="how_features_work.php#rusudissertation" id="id1"><span>[RusuDissertation]</span></a>.</p>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>If the dataset has multiple acquisition viewpoints, then the above normal re-orientation method does not hold, and more complex algorithms need to be implemented. Please see <a class="reference internal" href="how_features_work.php#rusudissertation" id="id2"><span>[RusuDissertation]</span></a> for more information.</p>
</div>
</div>
