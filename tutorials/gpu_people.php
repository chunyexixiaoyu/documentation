...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Detecting people and their poses using PointCloud Library &#8212; PCL 0.0 documentation</title>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>    <span class="n">DeviceArray</span><span class="o">&lt;</span><span class="n">pcl</span><span class="o">::</span><span class="n">RGB</span><span class="o">&gt;</span> <span class="n">color_map_</span><span class="p">;</span>
<span class="p">};</span>
...
<span class="p">{</span>
  ...
  <span class="n">std</span><span class="o">::</span><span class="n">vector</span><span class="o">&lt;</span><span class="n">string</span><span class="o">&gt;</span> <span class="n">tree_files</span><span class="p">;</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="n">pcl</span><span class="o">::</span><span class="n">Grabber</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">capture</span> <span class="p">(</span><span class="k">new</span> <span class="n">pcl</span><span class="o">::</span><span class="n">OpenNIGrabber</span><span class="p">());</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="n">pc</span><span class="o">::</span><span class="n">parse_argument</span> <span class="p">(</span><span class="n">argc</span><span class="p">,</span> <span class="n">argv</span><span class="p">,</span> <span class="s">&quot;-tree2&quot;</span><span class="p">,</span> <span class="n">tree_files</span><span class="p">[</span><span class="mi">2</span><span class="p">]);</span>
  <span class="n">pc</span><span class="o">::</span><span class="n">parse_argument</span> <span class="p">(</span><span class="n">argc</span><span class="p">,</span> <span class="n">argv</span><span class="p">,</span> <span class="s">&quot;-tree3&quot;</span><span class="p">,</span> <span class="n">tree_files</span><span class="p">[</span><span class="mi">3</span><span class="p">]);</span>
</pre></div>
</div>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>    <span class="n">RDFBodyPartsDetector</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">rdf</span><span class="p">(</span><span class="k">new</span> <span class="n">RDFBodyPartsDetector</span><span class="p">(</span><span class="n">tree_files</span><span class="p">));</span>
    <span class="n">PCL_INFO</span><span class="p">(</span><span class="s">&quot;Loaded files into rdf&quot;</span><span class="p">);</span>
...
16
17
18</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="nb">cmake_minimum_required</span><span class="p">(</span><span class="s">VERSION</span> <span class="s">2.8</span> <span class="s">FATAL_ERROR</span><span class="p">)</span>
