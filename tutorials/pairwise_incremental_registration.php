...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>How to incrementally register pairs of clouds &#8212; PCL 0.0 documentation</title>
...
372
373
374</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cm">/*</span>
...
<span class="cp">#include</span> <span class="cpf">&lt;boost/make_shared.hpp&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/point_representation.h&gt;</span><span class="cp"></span>
...
<span class="cp">#include</span> <span class="cpf">&lt;pcl/registration/icp_nl.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/registration/transforms.h&gt;</span><span class="cp"></span>
...
<span class="p">{</span>
  ...
  <span class="p">{</span>
    ...
    <span class="n">GlobalTransform</span> <span class="o">*=</span> <span class="n">pairTransform</span><span class="p">;</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="cp">#include</span> <span class="cpf">&lt;boost/make_shared.hpp&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/point_types.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/point_cloud.h&gt;</span><span class="cp"></span>
<span class="cp">#include</span> <span class="cpf">&lt;pcl/point_representation.h&gt;</span><span class="cp"></span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="c1">// This is a tutorial so we can afford having global variables </span>
	<span class="c1">//our visualizer</span>
	<span class="n">pcl</span><span class="o">::</span><span class="n">visualization</span><span class="o">::</span><span class="n">PCLVisualizer</span> <span class="o">*</span><span class="n">p</span><span class="p">;</span>
	<span class="c1">//its left and right viewports</span>
	<span class="kt">int</span> <span class="n">vp_1</span><span class="p">,</span> <span class="n">vp_2</span><span class="p">;</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">struct</span> <span class="n">PCD</span>
<span class="p">{</span>
  <span class="n">PointCloud</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">cloud</span><span class="p">;</span>
  <span class="n">std</span><span class="o">::</span><span class="n">string</span> <span class="n">f_name</span><span class="p">;</span>
...
<p>Define a new point representation (see <a class="reference internal" href="adding_custom_ptype.php#adding-custom-ptype"><span class="std std-ref">Adding your own custom PointT type</span></a> for more on the subject)</p>
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="c1">// Define a new point representation for &lt; x, y, z, curvature &gt;</span>
<span class="k">class</span> <span class="nc">MyPointRepresentation</span> <span class="o">:</span> <span class="k">public</span> <span class="n">pcl</span><span class="o">::</span><span class="n">PointRepresentation</span> <span class="o">&lt;</span><span class="n">PointNormalT</span><span class="o">&gt;</span>
<span class="p">{</span>
  <span class="k">using</span> <span class="n">pcl</span><span class="o">::</span><span class="n">PointRepresentation</span><span class="o">&lt;</span><span class="n">PointNormalT</span><span class="o">&gt;::</span><span class="n">nr_dimensions_</span><span class="p">;</span>
<span class="k">public</span><span class="o">:</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="kt">void</span> <span class="nf">loadData</span> <span class="p">(</span><span class="kt">int</span> <span class="n">argc</span><span class="p">,</span> <span class="kt">char</span> <span class="o">**</span><span class="n">argv</span><span class="p">,</span> <span class="n">std</span><span class="o">::</span><span class="n">vector</span><span class="o">&lt;</span><span class="n">PCD</span><span class="p">,</span> <span class="n">Eigen</span><span class="o">::</span><span class="n">aligned_allocator</span><span class="o">&lt;</span><span class="n">PCD</span><span class="o">&gt;</span> <span class="o">&gt;</span> <span class="o">&amp;</span><span class="n">models</span><span class="p">)</span>
<span class="p">{</span>
  <span class="n">std</span><span class="o">::</span><span class="n">string</span> <span class="n">extension</span> <span class="p">(</span><span class="s">&quot;.pcd&quot;</span><span class="p">);</span>
  <span class="c1">// Suppose the first argument is the actual test model</span>
  <span class="k">for</span> <span class="p">(</span><span class="kt">int</span> <span class="n">i</span> <span class="o">=</span> <span class="mi">1</span><span class="p">;</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="n">argc</span><span class="p">;</span> <span class="n">i</span><span class="o">++</span><span class="p">)</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="kt">void</span> <span class="n">pairAlign</span> <span class="p">(</span><span class="k">const</span> <span class="n">PointCloud</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">cloud_src</span><span class="p">,</span> <span class="k">const</span> <span class="n">PointCloud</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">cloud_tgt</span><span class="p">,</span> <span class="n">PointCloud</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">output</span><span class="p">,</span> <span class="n">Eigen</span><span class="o">::</span><span class="n">Matrix4f</span> <span class="o">&amp;</span><span class="n">final_transform</span><span class="p">,</span> <span class="kt">bool</span> <span class="n">downsample</span> <span class="o">=</span> <span class="nb">false</span><span class="p">)</span>
</pre></div>
</div>
<div class="line-block">
