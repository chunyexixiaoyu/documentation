...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Clustering of Pointclouds into Supervoxels - Theoretical primer &#8212; PCL 0.0 documentation</title>
...
<p class="caption"><span class="caption-text"><strong>An example of supervoxels and adjacency graph generated for a cloud</strong></span></p>
</div>
...
<p class="caption"><span class="caption-text"><strong>From right to left, 6 (faces), 18 (faces,edges), and 26 (faces, edges, vertices) adjacency</strong></span></p>
</div>
...
<p class="caption"><span class="caption-text"><strong>The various sizing parameters which affect supervoxel clustering. R_seed and R_voxel must both be set by the user.</strong></span></p>
</div>
...
<p class="caption"><span class="caption-text"><strong>Weighting equation used in supervoxel clustering. w_c, w_s, and w_n, the color, spatial, and normal weights, respectively, are user controlled parameters.</strong></span></p>
</div>
...
<p class="caption"><span class="caption-text"><strong>Search order in the adjacency octree for supervoxel cluster expansion. Dotted edges in the adjacency graph are not searched, since they have already been considered earlier in the queue.</strong></span></p>
</div>
...
Next, copy and paste the following code into your editor and save it as <code class="docutils literal notranslate"><span class="pre">supervoxel_clustering.cpp</span></code> (or download the source file <a class="reference download internal" download="" href="_downloads/1e7c2300101fcc40d562b9fbc00bcbd0/supervoxel_clustering.cpp"><code class="xref download docutils literal notranslate"><span class="pre">here</span></code></a>).</p>
...
165
166
167</pre></div></td><td class="code"><div class="highlight"><pre><span></span><span class="cp">#include</span> <span class="cpf">&lt;pcl/console/parse.h&gt;</span><span class="cp"></span>
...
<span class="c1">//VTK include needed for drawing graph lines</span>
<span class="cp">#include</span> <span class="cpf">&lt;vtkPolyLine.h&gt;</span><span class="cp"></span>
...
<span class="kt">void</span> <span class="nf">addSupervoxelConnectionsToViewer</span> <span class="p">(</span><span class="n">PointT</span> <span class="o">&amp;</span><span class="n">supervoxel_center</span><span class="p">,</span>
                                       ...
                                       <span class="n">pcl</span><span class="o">::</span><span class="n">visualization</span><span class="o">::</span><span class="n">PCLVisualizer</span><span class="o">::</span><span class="n">Ptr</span> <span class="o">&amp;</span> <span class="n">viewer</span><span class="p">);</span>
...
<span class="p">{</span>
  ...
  <span class="kt">bool</span> <span class="n">disable_transform</span> <span class="o">=</span> <span class="n">pcl</span><span class="o">::</span><span class="n">console</span><span class="o">::</span><span class="n">find_switch</span> <span class="p">(</span><span class="n">argc</span><span class="p">,</span> <span class="n">argv</span><span class="p">,</span> <span class="s">&quot;--NT&quot;</span><span class="p">);</span>
  ...
  <span class="n">pcl</span><span class="o">::</span><span class="n">SupervoxelClustering</span><span class="o">&lt;</span><span class="n">PointT</span><span class="o">&gt;</span> <span class="n">super</span> <span class="p">(</span><span class="n">voxel_resolution</span><span class="p">,</span> <span class="n">seed_resolution</span><span class="p">);</span>
  <span class="k">if</span> <span class="p">(</span><span class="n">disable_transform</span><span class="p">)</span>
    <span class="n">super</span><span class="p">.</span><span class="n">setUseSingleCameraTransform</span> <span class="p">(</span><span class="nb">false</span><span class="p">);</span>
  ...
  <span class="n">std</span><span class="o">::</span><span class="n">map</span> <span class="o">&lt;</span><span class="n">std</span><span class="o">::</span><span class="kt">uint32_t</span><span class="p">,</span> <span class="n">pcl</span><span class="o">::</span><span class="n">Supervoxel</span><span class="o">&lt;</span><span class="n">PointT</span><span class="o">&gt;::</span><span class="n">Ptr</span> <span class="o">&gt;</span> <span class="n">supervoxel_clusters</span><span class="p">;</span>
  ...
  <span class="n">PointLCloudT</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">labeled_voxel_cloud</span> <span class="o">=</span> <span class="n">super</span><span class="p">.</span><span class="n">getLabeledVoxelCloud</span> <span class="p">();</span>
  <span class="n">viewer</span><span class="o">-&gt;</span><span class="n">addPointCloud</span> <span class="p">(</span><span class="n">labeled_voxel_cloud</span><span class="p">,</span> <span class="s">&quot;labeled voxels&quot;</span><span class="p">);</span>
  <span class="n">viewer</span><span class="o">-&gt;</span><span class="n">setPointCloudRenderingProperties</span> <span class="p">(</span><span class="n">pcl</span><span class="o">::</span><span class="n">visualization</span><span class="o">::</span><span class="n">PCL_VISUALIZER_OPACITY</span><span class="p">,</span><span class="mf">0.8</span><span class="p">,</span> <span class="s">&quot;labeled voxels&quot;</span><span class="p">);</span>
  ...
  <span class="n">std</span><span class="o">::</span><span class="n">multimap</span><span class="o">&lt;</span><span class="n">std</span><span class="o">::</span><span class="kt">uint32_t</span><span class="p">,</span> <span class="n">std</span><span class="o">::</span><span class="kt">uint32_t</span><span class="o">&gt;</span> <span class="n">supervoxel_adjacency</span><span class="p">;</span>
  ...
  <span class="k">for</span> <span class="p">(</span><span class="k">auto</span> <span class="n">label_itr</span> <span class="o">=</span> <span class="n">supervoxel_adjacency</span><span class="p">.</span><span class="n">cbegin</span> <span class="p">();</span> <span class="n">label_itr</span> <span class="o">!=</span> <span class="n">supervoxel_adjacency</span><span class="p">.</span><span class="n">cend</span> <span class="p">();</span> <span class="p">)</span>
  <span class="p">{</span>
    <span class="c1">//First get the label</span>
    <span class="n">std</span><span class="o">::</span><span class="kt">uint32_t</span> <span class="n">supervoxel_label</span> <span class="o">=</span> <span class="n">label_itr</span><span class="o">-&gt;</span><span class="n">first</span><span class="p">;</span>
    ...
    <span class="k">for</span> <span class="p">(</span><span class="k">auto</span> <span class="n">adjacent_itr</span> <span class="o">=</span> <span class="n">supervoxel_adjacency</span><span class="p">.</span><span class="n">equal_range</span> <span class="p">(</span><span class="n">supervoxel_label</span><span class="p">).</span><span class="n">first</span><span class="p">;</span> <span class="n">adjacent_itr</span><span class="o">!=</span><span class="n">supervoxel_adjacency</span><span class="p">.</span><span class="n">equal_range</span> <span class="p">(</span><span class="n">supervoxel_label</span><span class="p">).</span><span class="n">second</span><span class="p">;</span> <span class="o">++</span><span class="n">adjacent_itr</span><span class="p">)</span>
    <span class="p">{</span>
...
<span class="p">{</span>
  ...
  <span class="k">for</span> <span class="p">(</span><span class="k">auto</span> <span class="n">adjacent_itr</span> <span class="o">=</span> <span class="n">adjacent_supervoxel_centers</span><span class="p">.</span><span class="n">begin</span> <span class="p">();</span> <span class="n">adjacent_itr</span> <span class="o">!=</span> <span class="n">adjacent_supervoxel_centers</span><span class="p">.</span><span class="n">end</span> <span class="p">();</span> <span class="o">++</span><span class="n">adjacent_itr</span><span class="p">)</span>
  <span class="p">{</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span><span class="k">typedef</span> <span class="n">pcl</span><span class="o">::</span><span class="n">PointXYZRGBA</span> <span class="n">PointT</span><span class="p">;</span>
<span class="k">typedef</span> <span class="n">pcl</span><span class="o">::</span><span class="n">PointCloud</span><span class="o">&lt;</span><span class="n">PointT</span><span class="o">&gt;</span> <span class="n">PointCloudT</span><span class="p">;</span>
<span class="k">typedef</span> <span class="n">pcl</span><span class="o">::</span><span class="n">PointNormal</span> <span class="n">PointNT</span><span class="p">;</span>
<span class="k">typedef</span> <span class="n">pcl</span><span class="o">::</span><span class="n">PointCloud</span><span class="o">&lt;</span><span class="n">PointNT</span><span class="o">&gt;</span> <span class="n">PointNCloudT</span><span class="p">;</span>
<span class="k">typedef</span> <span class="n">pcl</span><span class="o">::</span><span class="n">PointXYZL</span> <span class="n">PointLT</span><span class="p">;</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="n">PointCloudT</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">cloud</span> <span class="p">(</span><span class="k">new</span> <span class="n">PointCloudT</span><span class="p">);</span>
  <span class="n">pcl</span><span class="o">::</span><span class="n">console</span><span class="o">::</span><span class="n">print_highlight</span> <span class="p">(</span><span class="s">&quot;Loading point cloud...</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">);</span>
  <span class="k">if</span> <span class="p">(</span><span class="n">pcl</span><span class="o">::</span><span class="n">io</span><span class="o">::</span><span class="n">loadPCDFile</span><span class="o">&lt;</span><span class="n">PointT</span><span class="o">&gt;</span> <span class="p">(</span><span class="n">argv</span><span class="p">[</span><span class="mi">1</span><span class="p">],</span> <span class="o">*</span><span class="n">cloud</span><span class="p">))</span>
  <span class="p">{</span>
    <span class="n">pcl</span><span class="o">::</span><span class="n">console</span><span class="o">::</span><span class="n">print_error</span> <span class="p">(</span><span class="s">&quot;Error loading cloud file!</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="n">pcl</span><span class="o">::</span><span class="n">SupervoxelClustering</span><span class="o">&lt;</span><span class="n">PointT</span><span class="o">&gt;</span> <span class="n">super</span> <span class="p">(</span><span class="n">voxel_resolution</span><span class="p">,</span> <span class="n">seed_resolution</span><span class="p">);</span>
  <span class="k">if</span> <span class="p">(</span><span class="n">disable_transform</span><span class="p">)</span>
    <span class="n">super</span><span class="p">.</span><span class="n">setUseSingleCameraTransform</span> <span class="p">(</span><span class="nb">false</span><span class="p">);</span>
  <span class="n">super</span><span class="p">.</span><span class="n">setInputCloud</span> <span class="p">(</span><span class="n">cloud</span><span class="p">);</span>
  <span class="n">super</span><span class="p">.</span><span class="n">setColorImportance</span> <span class="p">(</span><span class="n">color_importance</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="n">std</span><span class="o">::</span><span class="n">map</span> <span class="o">&lt;</span><span class="n">std</span><span class="o">::</span><span class="kt">uint32_t</span><span class="p">,</span> <span class="n">pcl</span><span class="o">::</span><span class="n">Supervoxel</span><span class="o">&lt;</span><span class="n">PointT</span><span class="o">&gt;::</span><span class="n">Ptr</span> <span class="o">&gt;</span> <span class="n">supervoxel_clusters</span><span class="p">;</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="n">pcl</span><span class="o">::</span><span class="n">visualization</span><span class="o">::</span><span class="n">PCLVisualizer</span><span class="o">::</span><span class="n">Ptr</span> <span class="n">viewer</span> <span class="p">(</span><span class="k">new</span> <span class="n">pcl</span><span class="o">::</span><span class="n">visualization</span><span class="o">::</span><span class="n">PCLVisualizer</span> <span class="p">(</span><span class="s">&quot;3D Viewer&quot;</span><span class="p">));</span>
  <span class="n">viewer</span><span class="o">-&gt;</span><span class="n">setBackgroundColor</span> <span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">,</span> <span class="mi">0</span><span class="p">);</span>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>  <span class="n">pcl</span><span class="o">::</span><span class="n">console</span><span class="o">::</span><span class="n">print_highlight</span> <span class="p">(</span><span class="s">&quot;Getting supervoxel adjacency</span><span class="se">\n</span><span class="s">&quot;</span><span class="p">);</span>
  <span class="n">std</span><span class="o">::</span><span class="n">multimap</span><span class="o">&lt;</span><span class="n">std</span><span class="o">::</span><span class="kt">uint32_t</span><span class="p">,</span> <span class="n">std</span><span class="o">::</span><span class="kt">uint32_t</span><span class="o">&gt;</span> <span class="n">supervoxel_adjacency</span><span class="p">;</span>
  <span class="n">super</span><span class="p">.</span><span class="n">getSupervoxelAdjacency</span> <span class="p">(</span><span class="n">supervoxel_adjacency</span><span class="p">);</span>
</pre></div>
</div>
...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span>    <span class="c1">//Now we make a name for this polygon</span>
    <span class="n">std</span><span class="o">::</span><span class="n">stringstream</span> <span class="n">ss</span><span class="p">;</span>
    <span class="n">ss</span> <span class="o">&lt;&lt;</span> <span class="s">&quot;supervoxel_&quot;</span> <span class="o">&lt;&lt;</span> <span class="n">supervoxel_label</span><span class="p">;</span>
    <span class="c1">//This function is shown below, but is beyond the scope of this tutorial - basically it just generates a &quot;star&quot; polygon mesh from the points given</span>
    <span class="n">addSupervoxelConnectionsToViewer</span> <span class="p">(</span><span class="n">supervoxel</span><span class="o">-&gt;</span><span class="n">centroid_</span><span class="p">,</span> <span class="n">adjacent_supervoxel_centers</span><span class="p">,</span> <span class="n">ss</span><span class="p">.</span><span class="n">str</span> <span class="p">(),</span> <span class="n">viewer</span><span class="p">);</span>
