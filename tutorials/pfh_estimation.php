...
please go ahead and read the <a class="reference internal" href="normal_estimation.php#normal-estimation"><span class="std std-ref">Estimating Surface Normals in a PointCloud</span></a> tutorial first, as PFH
...
for a query point (<img class="math" src="_images/math/2fa9878d2c9dd8bc006ba9d7986fab0030ed8452.png" alt="p_q"/>), marked with red and placed in the middle of a
...
complexity of <img class="math" src="_images/math/0c54ec2390ec7c7cc19ef74f38272948b253af7d.png" alt="O(k^2)"/>.</p>
<img alt="_images/pfh_diagram.png" class="align-center" src="_images/pfh_diagram.png" />
<p>To compute the relative difference between two points <img class="math" src="_images/math/5247131b3b1b9cc457d29a9b08a19c2062ed3d16.png" alt="p_i"/> and
<img class="math" src="_images/math/c975c0ce699f1ada89a3ca5d97ed4a050bd67d74.png" alt="p_j"/> and their associated normals <img class="math" src="_images/math/29920eacb87ef0eb96e99aca37a523798ce98563.png" alt="n_i"/> and <img class="math" src="_images/math/9cfb281398248f5ece53f923cde4d3a6e17ef2e1.png" alt="n_j"/>, we
define a fixed coordinate frame at one of the points (see the figure below).</p>
<div class="math">
<p><img src="_images/math/988c9e17d0f554905cab4493b4688f6369f07385.png" alt="{\mathsf u} =&amp; \boldsymbol{n}_s \\
...
<img class="math" src="_images/math/5f0c5b9dedb3d5cdfa4b6f842857a9648617f697.png" alt="n_s"/> and <img class="math" src="_images/math/0dae3b16a416a9a9c11e35da12b2be21d2c1cbf1.png" alt="n_t"/> can be expressed as a set of angular features as
follows:</p>
<div class="math">
<p><img src="_images/math/607d1bf7e03b6c8ef48f2cebba18af18139d3937.png" alt="\alpha &amp;= {\mathsf v} \cdot \boldsymbol{n}_t \\
...
<img class="math" src="_images/math/0053ab21b9fddd21e96066d7a732704d1d9b7a83.png" alt="\boldsymbol{p}_s"/> and <img class="math" src="_images/math/05de75fec394c61909fafd639b37b012bb2e90e3.png" alt="\boldsymbol{p}_t"/>,
<img class="math" src="_images/math/d5d95ddb03ef0c436a303452506ae472a77c38cc.png" alt="d={\|\boldsymbol{p}_t-\boldsymbol{p}_s\|}_2"/>.  The quadruplet
<img class="math" src="_images/math/f7b6f91ce181c0939893a1271fd72ee1e7d6378f.png" alt="\langle\alpha, \phi, \theta, d\rangle"/> is computed for each pair of two
...
therefore create a histogram with <img class="math" src="_images/math/269ca7855d69f0343ed3b709c80f028cc1d1d4d7.png" alt="b^4"/> bins in a fully correlated space.
...
<p>For more information and mathematical derivations, including an analysis of PFH signatures for different surface geometries please see <a class="reference internal" href="how_features_work.php#rusudissertation" id="id1"><span>[RusuDissertation]</span></a>.</p>
</div>
</div>
...
distances too, if desired) which results in a 125-byte array (<img class="math" src="_images/math/528b6b269b86cf640f706bfcd5a3c9a84dc52d58.png" alt="5^3"/>) of
