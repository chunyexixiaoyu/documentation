...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <meta charset="utf-8" />
    <title>Estimating VFH signatures for a set of points &#8212; PCL 0.0 documentation</title>
...
<a class="reference internal" href="vfh_recognition.php#vfh-recognition"><span class="std std-ref">Cluster Recognition and 6DOF Pose Estimation using VFH descriptors</span></a> and/or <a class="reference internal" href="#vfh" id="id2"><span>[VFH]</span></a>.</p>
...
(see <a class="reference internal" href="fpfh_estimation.php#fpfh-estimation"><span class="std std-ref">Fast Point Feature Histograms (FPFH) descriptors</span></a>). Due to its speed and discriminative power, we
...
described in <a class="reference internal" href="fpfh_estimation.php#fpfh-estimation"><span class="std std-ref">Fast Point Feature Histograms (FPFH) descriptors</span></a> but now measured between the viewpoint
